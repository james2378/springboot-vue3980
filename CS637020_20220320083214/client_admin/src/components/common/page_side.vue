<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			,'/study_room_administrator/table'
			])">
			...
			<el-menu-item index="/study_room_administrator/table" v-show="user_group == '管理员' || $check_action('/study_room_administrator/table')"><span>自习室管理员</span></el-menu-item>
			...
			auth() {
				...
				for (var i = 0; i < tables.length; i++) {
					...
					if (o.path.indexOf("/table") !== -1) {
						...
						list.push("study_room_administrator");
